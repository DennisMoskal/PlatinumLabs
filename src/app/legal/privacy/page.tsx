...
export default function PrivacyPage() {
  return (
    <div className="maestro-main-bg">
      {/* Background Effects – wie auf der Hauptseite */}
      ...
      {/* Navigation – identisches Styling */}
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/legal/privacy" className="text-white font-medium transition-colors hover:drop-shadow">Legal</Link>
            </div>
          </div>
        </div>
      </nav>
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="max-w-4xl mx-auto maestro-card rounded-2xl p-8 md:p-10">
          <h1 className="text-4xl font-bold text-white mb-8 maestro-text-glow">Privacy Policy</h1>
          ...
          <div className="space-y-8 text-gray-300">
            ...
            <section>
              ...
              <p className="mt-4">
                If you have any questions about data protection, please contact us at <span className="underline decoration-purple-400/60">dennismoskal@yahoo.com</span>.
              </p>
            </section>
